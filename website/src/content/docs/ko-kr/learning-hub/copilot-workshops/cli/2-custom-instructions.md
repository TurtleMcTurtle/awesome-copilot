...
2. Copilot CLI가 설치 및 인증되었는지 확인합니다.
   ...
   명령을 찾을 수 없거나 아직 로그인하지 않았다면 [연습 1 - GitHub Copilot CLI 설치](/ko-kr/learning-hub/copilot-workshops/cli/1-install-copilot-cli/)로 돌아갑니다.
...
[previous-lesson]: /ko-kr/learning-hub/copilot-workshops/cli/1-install-copilot-cli/
[next-lesson]: /ko-kr/learning-hub/copilot-workshops/cli/3-generating-code/
