...
2. 잠시 후 Copilot CLI가 현재 컨텍스트를 시각적으로 표현한 결과를 생성합니다.
    ...
    ![Copilot CLI의 context window 화면](/images/learning-hub/copilot-workshops/cli-7-context-window.png)
...
5. 이 harness에서는 pull request가 완료될 때까지 기다릴 필요는 없습니다. 나중에 다시 돌아와도 됩니다. 비동기 agent 작업 관리 방법을 더 깊이 알아보고 싶다면 [Cloud agent harness](/ko-kr/learning-hub/copilot-workshops/cloud/)를 계속 진행합니다.
...
[previous-lesson]: /ko-kr/learning-hub/copilot-workshops/cli/6-custom-agents/
[next-lesson]: /ko-kr/learning-hub/copilot-workshops/cli/8-review/
