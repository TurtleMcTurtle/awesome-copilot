...
GitHub Copilot 생태계를 더 살펴보고 싶다면 [VS Code harness](/ko-kr/learning-hub/copilot-workshops/vscode/) 또는 [Cloud agent harness](/ko-kr/learning-hub/copilot-workshops/cloud/)를 확인합니다.
...
[previous-lesson]: /ko-kr/learning-hub/copilot-workshops/cli/7-slash-commands/
