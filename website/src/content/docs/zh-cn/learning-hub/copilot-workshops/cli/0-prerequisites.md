...
2. 在实验存储库页面上，选择 **Use this template** 按钮创建自己的存储库副本。然后选择 **Create a new repository**。
    ...
    ![“Use this template”按钮](/images/learning-hub/copilot-workshops/ex0-use-template.png)

3. 如果参加的是由 GitHub 或 Microsoft 主办的活动，请按照导师提供的说明操作。否则，可以在已启用 GitHub Copilot 访问权限的组织中创建这个新存储库。

    ![输入存储库模板设置](/images/learning-hub/copilot-workshops/ex0-repository-settings.png)
...
2. 选择绿色的 **Code** 按钮。
    ...
    ![选择 Code 按钮](/images/learning-hub/copilot-workshops/ex0-code-button.png)

3. 选择 **Codespaces** 选项卡，再选择 **+** 按钮创建新的 Codespace。

    ![创建新的 codespace](/images/learning-hub/copilot-workshops/ex0-create-codespace.png)
...
[next-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/1-install-copilot-cli/