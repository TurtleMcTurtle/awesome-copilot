...
如果想继续探索 GitHub Copilot 生态系统，可以查看 [VS Code 路径](/zh-cn/learning-hub/copilot-workshops/vscode/) 或 [Cloud agent 路径](/zh-cn/learning-hub/copilot-workshops/cloud/)。
...
[previous-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/7-slash-commands/
