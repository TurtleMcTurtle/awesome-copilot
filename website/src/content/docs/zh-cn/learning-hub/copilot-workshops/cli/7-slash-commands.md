...
2. 稍等片刻后，Copilot CLI 会生成当前上下文的可视化表示：
    ...
    ![Copilot CLI 上下文窗口截图](/images/learning-hub/copilot-workshops/cli-7-context-window.png)
...
5. 在这个路径中，无需等待 pull request 完成；稍后可以再回来查看。如果想更深入了解如何管理异步 agent 工作，可继续学习 [Cloud agent 路径](/zh-cn/learning-hub/copilot-workshops/cloud/)。
...
[previous-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/6-custom-agents/
[next-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/8-review/
