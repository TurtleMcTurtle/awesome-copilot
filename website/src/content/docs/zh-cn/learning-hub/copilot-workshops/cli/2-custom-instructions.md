...
2. 确认 Copilot CLI 已安装并完成验证：
   ...
   如果找不到该命令，或者尚未登录，请返回[练习 1 - 安装 GitHub Copilot CLI](/zh-cn/learning-hub/copilot-workshops/cli/1-install-copilot-cli/)。
...
[previous-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/1-install-copilot-cli/
[next-lesson]: /zh-cn/learning-hub/copilot-workshops/cli/3-generating-code/
