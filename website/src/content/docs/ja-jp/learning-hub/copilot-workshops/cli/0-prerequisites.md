...
2. ラボ用リポジトリ ページの **Use this template** ボタンを選択して、自分用のリポジトリ コピーを作成します。次に **Create a new repository** を選択します。
    ...
    ![「Use this template」ボタン](/images/learning-hub/copilot-workshops/ex0-use-template.png)
...
3. GitHub または Microsoft が主催するイベントの一環としてこのワークショップを進めている場合は、メンターから案内された手順に従ってください。そうでない場合は、GitHub Copilot にアクセスできる organization に新しいリポジトリを作成できます。
    ...
    ![リポジトリ テンプレートの設定を入力する画面](/images/learning-hub/copilot-workshops/ex0-repository-settings.png)
...
2. 緑色の **Code** ボタンを選択します。
    ...
    ![「Code」ボタンを選択する](/images/learning-hub/copilot-workshops/ex0-code-button.png)

3. **Codespaces** タブを選択し、**+** ボタンを選択して新しい codespace を作成します。

    ![新しい codespace を作成する](/images/learning-hub/copilot-workshops/ex0-create-codespace.png)
...
[next-lesson]: /ja-jp/learning-hub/copilot-workshops/cli/1-install-copilot-cli/