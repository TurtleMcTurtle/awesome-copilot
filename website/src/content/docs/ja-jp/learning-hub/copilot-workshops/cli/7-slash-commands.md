...
2. 少し待つと、Copilot CLI が現在のコンテキストを視覚的に表現した表示を生成します。
    ...
    ![Copilot CLI の context window のスクリーンショット](/images/learning-hub/copilot-workshops/cli-7-context-window.png)
...
[previous-lesson]: /ja-jp/learning-hub/copilot-workshops/cli/6-custom-agents/
[next-lesson]: /ja-jp/learning-hub/copilot-workshops/cli/8-review/
...
[cloud-harness-link]: /ja-jp/learning-hub/copilot-workshops/cloud/