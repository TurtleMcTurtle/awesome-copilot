...
2. Copilot CLI がインストール済みで、認証されていることを確認します。
   ...
   コマンドが見つからない場合や、まだログインしていない場合は、[演習 1 - GitHub Copilot CLI のインストール](/ja-jp/learning-hub/copilot-workshops/cli/1-install-copilot-cli/) に戻ってください。
...
[previous-lesson]: /ja-jp/learning-hub/copilot-workshops/cli/1-install-copilot-cli/
[next-lesson]: /ja-jp/learning-hub/copilot-workshops/cli/3-generating-code/
