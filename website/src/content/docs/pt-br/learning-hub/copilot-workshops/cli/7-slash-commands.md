...
2. Em poucos instantes, o Copilot CLI gerará uma representação visual do contexto atual:
    ...
    ![Captura de tela da janela de contexto do Copilot CLI](/images/learning-hub/copilot-workshops/cli-7-context-window.png)
...
5. Você não precisa esperar a conclusão do pull request neste percurso. Pode voltar a ele mais tarde. Se quiser se aprofundar no gerenciamento de trabalho assíncrono com agentes, continue no [percurso do agente de nuvem](/pt-br/learning-hub/copilot-workshops/cloud/).
...
[previous-lesson]: /pt-br/learning-hub/copilot-workshops/cli/6-custom-agents/
[next-lesson]: /pt-br/learning-hub/copilot-workshops/cli/8-review/
