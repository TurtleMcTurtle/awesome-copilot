...
2. Confirme que o Copilot CLI está instalado e autenticado:
   ...
   Se o comando não for encontrado ou se você ainda não tiver feito login, volte para a [Lição 1 - Instalar o GitHub Copilot CLI](/pt-br/learning-hub/copilot-workshops/cli/1-install-copilot-cli/).
...
[previous-lesson]: /pt-br/learning-hub/copilot-workshops/cli/1-install-copilot-cli/
[next-lesson]: /pt-br/learning-hub/copilot-workshops/cli/3-generating-code/
