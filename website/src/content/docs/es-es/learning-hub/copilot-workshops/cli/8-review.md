...
Si quieres explorar más del ecosistema de GitHub Copilot, consulta el [recorrido de VS Code](/es-es/learning-hub/copilot-workshops/vscode/) o el [recorrido de Cloud agent](/es-es/learning-hub/copilot-workshops/cloud/).
...
[previous-lesson]: /es-es/learning-hub/copilot-workshops/cli/7-slash-commands/
