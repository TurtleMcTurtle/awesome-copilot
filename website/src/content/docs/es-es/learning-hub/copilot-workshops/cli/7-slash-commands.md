...
2. En apenas unos instantes, Copilot CLI generará una representación visual de su contexto actual:
    ...
    ![Captura de la ventana de contexto de Copilot CLI](/images/learning-hub/copilot-workshops/cli-7-context-window.png)
...
5. No necesitas esperar a que la pull request termine en este recorrido; puedes volver más tarde. Si quieres profundizar en la gestión del trabajo asíncrono con agentes, continúa con el [recorrido de Cloud agent](/es-es/learning-hub/copilot-workshops/cloud/).
...
[previous-lesson]: /es-es/learning-hub/copilot-workshops/cli/6-custom-agents/
[next-lesson]: /es-es/learning-hub/copilot-workshops/cli/8-review/
