...
2. Confirma que Copilot CLI está instalado y autenticado:
   ...
   Si no se encuentra el comando o no has iniciado sesión, vuelve al [Ejercicio 1 - Instalar GitHub Copilot CLI](/es-es/learning-hub/copilot-workshops/cli/1-install-copilot-cli/).
...
[previous-lesson]: /es-es/learning-hub/copilot-workshops/cli/1-install-copilot-cli/
[next-lesson]: /es-es/learning-hub/copilot-workshops/cli/3-generating-code/
